...
public class FriendshipInfo implements Observer {
	...
	private FriendshipInfo() {
		...
		friends = new HashMap<String, List<FriendProfile>>();
	...
	private void refresh() {
		...
		List<TIMFriendGroup> timFriendGroups = TIMFriendshipProxy.getInstance()
				.getFriendsByGroups(null);
		if (timFriendGroups == null)
			return;
		for (TIMFriendGroup group : timFriendGroups) {
			groups.add(group.getGroupName());
			List<FriendProfile> friendItemList = new ArrayList<FriendProfile>();
