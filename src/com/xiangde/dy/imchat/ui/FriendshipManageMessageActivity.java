...
import com.xiangde.dy.imchat.adapters.FriendManageMessageAdapter;
import com.xiangde.dy.imchat.model.FriendFuture;
...
public class FriendshipManageMessageActivity extends Activity implements FriendshipMessageView {
    ...
    private List<FriendFuture> list= new ArrayList<FriendFuture>();
