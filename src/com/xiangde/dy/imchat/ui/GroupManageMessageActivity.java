...
import com.xiangde.dy.imchat.adapters.GroupManageMessageAdapter;
import com.xiangde.dy.imchat.model.GroupFuture;

public class GroupManageMessageActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new GroupManageMessageAdapter(this, R.layout.item_three_line,
				list);
	...
	public void onGetGroupManageMessage(List<TIMGroupPendencyItem> message) {
		List<GroupFuture> futures = new ArrayList<GroupFuture>();
