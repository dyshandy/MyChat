...
import com.xiangde.dy.imchat.adapters.ProfileSummaryAdapter;
import com.xiangde.dy.imchat.model.GroupMemberProfile;
import com.xiangde.dy.imchat.model.ProfileSummary;

public class GroupMemberActivity extends Activity implements
		TIMValueCallBack<List<TIMGroupMemberInfo>> {

	ProfileSummaryAdapter adapter;
	List<ProfileSummary> list = new ArrayList<ProfileSummary>();
	ListView listView;
	String groupId, type;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new ProfileSummaryAdapter(this,
				R.layout.item_profile_summary, list);
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(GroupMemberActivity.this,
						GroupMemberProfileActivity.class);
				GroupMemberProfile profile = (GroupMemberProfile) list
						.get(position);
		...
		if (MEM_REQ == requestCode) {
			if (resultCode == RESULT_OK) {
				...
				if (isKick) {
					...
					GroupMemberProfile profile = (GroupMemberProfile) data
							.getSerializableExtra("data");
					if (memIndex < list.size()
							&& list.get(memIndex).getIdentify()
									.equals(profile.getIdentify())) {
						GroupMemberProfile mMemberProfile = (GroupMemberProfile) list
								.get(memIndex);
