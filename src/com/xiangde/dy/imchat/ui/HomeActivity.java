...
import com.xiangde.dy.imchat.ui.customview.DialogActivity;
...
public class HomeActivity extends FragmentActivity {
	...
	private final Class fragmentArray[] = { ConversationFragment.class,
			ContactFragment.class, SettingFragment.class };
	private int mTitleArray[] = { R.string.home_conversation_tab,
			R.string.home_contact_tab, R.string.home_setting_tab };
	private int mImageViewArray[] = { R.drawable.tab_huihua,
			R.drawable.tab_contact, R.drawable.tab_profile };
